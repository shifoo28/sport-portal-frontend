...
export const GET_FEDERATION_TRAINERS_SUCCESS = "GET_FEDERATION_TRAINERS_SUCCESS";
...
export const GET_FEDERATION_ATHLETES_SUCCESS = "GET_FEDERATION_ATHLETES_SUCCESS";
